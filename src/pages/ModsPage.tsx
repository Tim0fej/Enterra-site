...
import { ENTERRA_MODPACK, SERVER_CONFIG } from '../config';
import {
  FABRIC_FORBIDDEN,
  FABRIC_GAME_VERSION,
  FABRIC_MODS,
...
export function ModsPage() {
  ...
  return (
    <PageShell
      title="Моды Fabric"
      subtitle={`Рекомендуемый набор для комфортной игры на Enterra · Minecraft ${FABRIC_GAME_VERSION}`}
      wide
    >
      <div className="card mods-pack">
        <div className="mods-pack__main">
          ...
          <ol className="mods-steps mods-pack__steps">
            ...
            <li>
              Запусти лаунcher с профилем Fabric {FABRIC_GAME_VERSION} и зайди на{' '}
      ...
      <div className="mods-intro card">
        <p>
          ...
          <strong>CurseForge</strong> (версия {FABRIC_GAME_VERSION}, loader Fabric).
        </p>
        <ol className="mods-steps">
          <li>
            Установи{' '}
            <a href="https://fabricmc.net/use/" target="_blank" rel="noopener noreferrer">
              Fabric Loader {FABRIC_GAME_VERSION}
            </a>
          </li>
        ...
        <p className="muted mods-intro__note">
          ...
          мода). Iris — по желанию, для красивой графики.
        </p>
      </div>
